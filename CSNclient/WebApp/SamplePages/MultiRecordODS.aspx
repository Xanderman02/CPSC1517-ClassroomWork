...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:GridView ID="ProductList" runat="server"
            AutoGenerateColumns="False" OnSelectedIndexChanged="ProductList_SelectedIndexChanged" AllowPaging="True" DataSourceID="ProductListODS"
             >
              <Columns>
            ...
            <EmptyDataTemplate>
                No Products to display for selected... cateogory
            </EmptyDataTemplate>
