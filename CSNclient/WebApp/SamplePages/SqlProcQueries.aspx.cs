...
namespace WebApp.SamplePages
{
    public partial class SqlProcQueries : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (datainfo.Count() == 0)
                    {
                        ...
                        //    AND your data source is empty of records (data source physically exists) then
                        //    message in the template will be displayed
        ...
        protected void CategoryProductList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            //    reissue the call to the database for data 
