    ...
    <table align="center" style="width: 80%">
        <tr>
            ...
            <td>
                ...
                &nbsp&nbsp 
                <asp:Button ID="SubmitButton" runat="server" Text="Submit Choice" />
            </td>
        </tr>
        <tr>
            <td align="right">
                <asp:Label ID="Label1" runat="server" Text="Choice (RadioButtonList):" Font-Size="Medium" ForeColor="#009900"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBoxChoice" runat="server" Text="(active when check)" Font-Bold="True" />
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            <td colspan="2" align="center"><asp:Label> ID="OutputMessage" runat="server"</asp:Label></td>
        </tr>
    </table>
