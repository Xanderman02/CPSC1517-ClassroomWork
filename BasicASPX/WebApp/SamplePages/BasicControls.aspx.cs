...
namespace WebApp.SamplePages
{
    public partial class BasicControls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // this event method is executed BEFORE ANY EVENT
            // method is processed

            // clear out all old messages
            OutputMessage.Text = "";

            // this page is an excellent place to do page initilization of your controls
            // there is a property to test for post back of your page called Page.IsPostBack(Razor: IsPost)
            if(!Page.IsPostBack)
            {
                // do 1st page initilization processing
                ...
                // c) physicallty bind the data to the control for show
        ...
        protected void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            // to access the data of a control, you use the appropriate control (object) property (get, set)
